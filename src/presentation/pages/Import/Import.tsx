  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">Upload a CSV file to import customer data</p>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg border border-gray-200 dark:border-surface-700 bg-gray-50 dark:bg-surface-800 p-6">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">
              Expected Customer CSV Format
            </h2>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Your CSV file should contain the following columns:
            </p>
            <div className="grid gap-2 text-sm grid-cols-2 md:grid-cols-3">
